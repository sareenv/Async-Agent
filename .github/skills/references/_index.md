...
| File | Description |
|------|-------------|
| `continuations.md` | Migrating callback-based code using continuations |
...
- **Bridge callback APIs** → `continuations.md`, `async-sequences.md` (AsyncStream)
...
| `continuations.md` | ~200 | Callback migration |
